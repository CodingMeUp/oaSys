...
export let getCurrentSidebarMenu = function () {
  ...
  for (let i = 0; i < simpleMenuData.length; i++) {
    ...
    if (menu.path == location.hash.split('#')[1].split('?')[0]) {
...
function getMenusData() {
  ...
  let sidebarMenuData = {
    // 'case': [
    //     {text: '表单校验11111', icon: 'fa-arrow-right', path: '/case/MyForm'},
    //     {
    //         text: '管理', icon: 'fa-th-list',
    //         children: [
    //             {text: '仪表盘1111', icon: 'fa-arrow-right', path: '/case/Dashboard'},
    //             {text: '我的时间111', icon: 'fa-arrow-right', path: '/case/MyTime'},
    //             {text: '校验demo111', icon: 'fa-arrow-right', path: '/case/ValidationDemo'}
    //         ]
    //     }
    // ],
    // 'dashboard': [
    //     {text: '表单校验11111', icon: 'fa-arrow-right', path: '/dashboard/MyForm'},
    //     {text: '仪表盘1111', icon: 'fa-arrow-right', path: '/dashboard/Dashboard'},
    //     {text: '我的时间111', icon: 'fa-arrow-right', path: '/dashboard/MyTime'},
    //     {text: '校验demo111', icon: 'fa-arrow-right', path: '/dashboard/ValidationDemo'}
    // ],
    // 'project': [
    //     {text: '表单校验11111', icon: 'fa-arrow-right', path: '/project/MyForm'},
    //     {text: '仪表盘1111', icon: 'fa-arrow-right', path: '/project/Dashboard'},
    //     {text: '我的时间111', icon: 'fa-arrow-right', path: '/project/MyTime'},
    //     {text: '校验demo111', icon: 'fa-arrow-right', path: '/project/ValidationDemo'}
    // ],
    // 'system': [
